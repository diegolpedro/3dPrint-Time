...
¿Que quisiera filtrar? Me interesa toda aquella etiqueta relacionada con movimientos, velocidades, aceleraciones, etc. Ahora, ¿cuáles son esas etiquetas? Lo primero que se me viene a la mente es utilizar un programa para analizarlos. Yo elegí gCodeViewer <http://gcode.ws/>, pero podría ser cualquiera.
...
Para hacer la extracción utilizare un sencillo programa en python que reciba todos los archivos de un directorio, filtre los campos que necesito y cuente las etiquetas previamente comentadas.

```{r cars}
summary(cars)
```

Posible inclusión de campos.
...
-solid_infill_speed: velocidad de relleno de sólidos.
